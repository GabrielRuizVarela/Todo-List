    ...
    const addTask = ()=>{
        ...
        if (add) {
            ...
            document.querySelector('#add-task-button').addEventListener('click',()=>{
                ...
                date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'yyyy-M-d', new Date());
                document.querySelector('.add-container').remove();
                add = true;
                _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('addTask', {name, description, date});
            })
        } else {
            document.querySelector('.add-container').remove();
        }
                ...
                <div class="todo-text">
                    ...
                    <div class="todo-buttons">
                        <button class="todo-date" type="button">
                            ...
                            <div class="todo-date-text">${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.date,'d/M')}</div>
                        </button>
